...
const tools: Tool[] = [
  ...
  { name: "m365-tenant-diff", command: "s8tenantdiff compare", category: "Change", description: "Capture normalized tenant snapshots and explain added, removed and changed configuration.", mode: "Capture + offline comparison" },
  ...
  { name: "m365-security-baseline", command: "s8secure full", category: "Governance", description: "Assess Conditional Access, privileged roles and enterprise application posture.", mode: "Live or offline fixture" },
