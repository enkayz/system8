...
const tools: Tool[] = [
  ...
  { name: "m365-tenant-diff", command: "s8diff doctor", category: "Change", description: "Capture normalized tenant snapshots and explain added, removed and changed configuration.", mode: "Capture + offline comparison" },
  ...
  { name: "m365-migration-estimator", command: "s8migrate template", category: "Planning", description: "Estimate effort, elapsed time, risk and optional customer-priced cost from CSV input.", mode: "Offline · no tenant access" },
  { name: "m365-entitlement-advisor", command: "s8entitlement template", category: "Planning", description: "Compare service-plan entitlements with explicit persona and capability requirements.", mode: "Microsoft Graph · read-only" },
  ...
  { name: "m365-access-explainer", command: "s8access doctor", category: "Governance", description: "Trace a user's access through nested membership, applications, ownership and licensing.", mode: "Microsoft Graph · read-only" },
  { name: "m365-leaver-readiness", command: "s8leaver doctor", category: "Continuity", description: "Map ownership, reporting, membership and OneDrive dependencies before offboarding.", mode: "Microsoft Graph · read-only" },
