...
s8diff capture -InstallDependencies -OutputPath .\baseline
s8diff compare -BaselinePath .\baseline\tenant-snapshot.json -CurrentPath .\current\tenant-snapshot.json
```
